...
<body>
    ...
    <div class="container">
        <div class="section">
            ...
            <div class="text-box">
                <p>
                    List and describe your technical and professional skills that are directly 
                    related to your job or career field. Include programming languages, software 
                    proficiency, technical tools, industry-specific knowledge, methodologies, 
                    and any other competencies relevant to your professional work.
                </p>
                <p style="margin-top: 15px;">
                    Examples: Programming languages (Java, Python, C++), Software (Microsoft Office, 
                    Adobe Creative Suite), Technical skills (Data Analysis, Project Management), 
                    Industry knowledge, Certifications, and specialized training.
                </p>
            </div>
        </div>
        ...
        <div class="section">
            ...
            <div class="text-box">
                <p>
                    Describe your interpersonal and transferable skills that complement your 
                    technical abilities. Include communication skills, leadership qualities, 
                    teamwork abilities, problem-solving capabilities, adaptability, time management, 
                    and other personal attributes that make you an effective professional.
                </p>
                <p style="margin-top: 15px;">
                    Examples: Communication (written and verbal), Leadership, Team collaboration, 
